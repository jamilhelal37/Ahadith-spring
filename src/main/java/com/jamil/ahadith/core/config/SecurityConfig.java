    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/actuator/info", "/actuator/metrics", "/actuator/metrics/**",
                                "/actuator/prometheus")
                        ...
                        .hasAuthority(SecurityRoleUtils.authority(UserType.admin))
                        .requestMatchers("/scholar/**", "/api/v1/scholar/**")
                        .hasAnyAuthority(
                        ...
                        .requestMatchers(HttpMethod.DELETE,
                                ...
                                "/notifications/**", "/upgrade-requests/**")
                        .hasAuthority(SecurityRoleUtils.authority(UserType.admin))
                        .requestMatchers("/me/**", "/api/v1/me/**", "/search/history/**")
                        .authenticated()
                        .requestMatchers(HttpMethod.GET, "/ahadith/**", "/api/v1/ahadith/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/books/**", "/api/v1/books/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/rawis/**", "/api/v1/rawis/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/rulings/**", "/api/v1/rulings/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/topics/**", "/api/v1/topics/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/muhaddiths/**", "/api/v1/muhaddiths/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/explaining/**", "/api/v1/explaining/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/fake-ahadith/**", "/api/v1/fake-ahadith/**").permitAll()
