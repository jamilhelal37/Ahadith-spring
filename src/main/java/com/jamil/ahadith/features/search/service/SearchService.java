...
import com.jamil.ahadith.features.account.repository.*;
import com.jamil.ahadith.features.audit.repository.*;
import com.jamil.ahadith.features.auth.repository.*;
import com.jamil.ahadith.features.catalog.repository.*;
import com.jamil.ahadith.features.hadith.repository.*;
import com.jamil.ahadith.features.interaction.repository.*;
import com.jamil.ahadith.features.notification.repository.*;
import com.jamil.ahadith.features.search.repository.*;
import com.jamil.ahadith.features.upgrade.repository.*;
import com.jamil.ahadith.features.user.repository.*;
