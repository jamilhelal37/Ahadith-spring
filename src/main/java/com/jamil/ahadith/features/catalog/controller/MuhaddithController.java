...
import com.jamil.ahadith.features.catalog.service.MuhaddithService;
...
public class MuhaddithController {
    ...
    public ResponseEntity<MuhaddithResponseDto> createMuhaddith(@Valid @RequestBody MuhaddithRequestDto request,
        ...
        var uri = uriBuilder.path("/api/v1/admin/muhaddiths/{id}").buildAndExpand(muhaddith.getId()).toUri();
